# -*- encoding: utf-8 -*-
"""
locksmith.ui.vault.identifiers.delete module

Dialog for deleting identifiers with confirmation
"""
...
class DeleteIdentifierDialog(LocksmithResourceDeletionDialog):
    ...
    def __init__(self, identifier_alias: str, icon_path: str, app, parent: "VaultPage" = None):
        """
        Initialize the DeleteIdentifierDialog.
        ...
        logger.info(f"DeleteIdentifierDialog initialized for '{identifier_alias}'")
